    ...
    <el-card>
      <template #header>
        <div class="header-wrapper">
          <span class="title">Category Information</span>
          ...
          <div class="title-search">
            ...
            <div class="tip-container">
              <ul class="search-tip">
                <li>Level 1 Category ID or Name</li>
                <li>Level 2 Category ID or Name</li>
                <li>Example: C001 Release exterior, C00102 Acrid and cool release exterior</li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <el-table :data="pagedData" style="width: 100%">
        <el-table-column label="Level 1 Category ID">
        ...
        <el-table-column label="Level 1 Category Name">
          <template #default="scope">
            <el-link type="primary" @click="goDetail(scope.row.level1Id)">
        ...
        <el-table-column label="Level 2 Category Name">
          <template #default="scope">
            <el-link type="success" @click="goDetail(scope.row.level2Id)">
    ...
    loadCategory() {
      request.get('/api/medicine-category/all').then(res => {
        if (res.code === '200') {
          ...
          this.$message.error(res.msg || 'Failed to fetch category information')
        }
      })
    },
    doSearch() {
