    ...
    <div style=" background-color: white; width: 50%; border-radius: 5px; overflow: hidden">
      ...
      <div style=" display: flex; align-items: center; justify-content: center;margin-bottom: 60px">
        <el-form :model="user" style="width: 80%" :rules="rules" ref="loginRef">
          <div style="font-size: 20px; font-weight: bold; text-align: center; margin-bottom: 20px">欢迎登录中医药知识图谱管理与可视化系统</div>
          ...
          <el-form-item>
            <el-button style="width: 100%;background-color: #2eab8c;color: white" @click="login">登 录</el-button>
          </el-form-item>
          <div style="display: flex">
            <div style="flex: 1">还没有账号？请 <span style="color: #0f9876; cursor: pointer" @click="$router.push('/register')">注册</span></div>
            <div style="flex: 1; text-align: right"><span style="color: #0f9876; cursor: pointer" @click="handleForgetPassDialogVis">忘记密码</span></div>
          </div>
        </el-form>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    handleForgetPassDialogVis(){//初始化表单
      this.forgetUserForm = {}
